...
const arrowDownIconStyles = (size, color) => css`
  display: block;
  width: ${size}px;
  height: ${size}px;
  fill: ${color};
...
const ArrowDownIcon = ({ size = 24, color = Color.Ink, ...props }) => {
  return (
    <svg css={arrowDownIconStyles(size, color)} {...props} xmlns='http://www.w3.org/2000/svg' viewBox='0 0 512 512'>
